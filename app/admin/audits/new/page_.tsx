...
function StepValidate({ saveDraft, saveCompleted }: { saveDraft: () => void; saveCompleted: () => void }) {
  return (
    <div>
...
export default function Page() {
  ...
  return (
    <div className="p-6">
      ...
      {step === 2 && (
        <StepContacts form={form} setForm={setForm} />
      )}

      {step === 3 && (
        <StepSales form={form} setForm={setForm} />
      )}
